...
func (m *SysctlConfig) MarshalBinary() ([]byte, error) { _ = "STUB: not implemented"; return nil, nil }

// UnmarshalBinary interface implementation
func (m *SysctlConfig) UnmarshalBinary(b []byte) error { _ = "STUB: not implemented"; return nil }
